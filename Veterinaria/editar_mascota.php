...
<html lang="en">
  ...
  <div class="shadow-sm p-3 mb-5 bg-body rounded">
      ...
      <div class="text-center">
        <form class="" method="POST" action="edit_mascota.php">
        <h3 class="pb-3">Editar MASCOTA</h3>
                    ...
                    <div class=" row">
                        ...
                        <div class="row py-2">
                            ...
                            <label for="peso_medio" class="form-label">Peso Medio:</label>
                                <input type="number" id="peso_medio" name="peso_medio" class="input-texto shadow-sm rounded form-control">
                            </div>
                        </div>
                    </div>
                    </div>
