...
<html lang="en">
  ...
  <div class="shadow-sm p-3 mb-5 bg-body rounded">
      ...
      <h5 class="text-center py-2">MODULO MASCOTA</h5>
          <div class="row">
            <div class="p-1 ">
  
                <div class="card shadow-sm rounded-3 carta py-1">
                  <a class="icono" href="tabla_mascota.php">
                  <ion-icon class="icons" name="bar-chart-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Tabla Mascota</h6>
                  </div>
              </a>
                </div>
            ...
            <div class="p-1 py-3">
                ...
                <div class="card shadow-sm rounded-3 carta">
                  <a class="icono" href="agregar_mascota.php">
                  <ion-icon class="icons" name="add-circle-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Agregar Mascota</h6>
                  </div>
              </a>
                </div>
            ...
            <div class="p-1 py-3">
                ...
                <div class="card shadow-sm rounded-3 carta" >
                  <a class="icono" href="editar_mascota.php">
                  <ion-icon class="icons" name="create-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Editar Mascota</hh6>
                  </div>
              </a>
                </div>
