...
<html lang="en">
  ...
  <div class="shadow-sm p-3 mb-5 bg-body rounded">
      ...
      <h5 class="text-center py-2">MODULO CLIENTE</h5>
          <div class="row">
            <div class="p-1 ">
  
                <div class="card shadow-sm rounded-3 carta py-1">
                  <a class="icono" href="tabla_cliente.php">
                  <ion-icon class="icons" name="bar-chart-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Tabla Clientes</h6>
                  </div>
              </a>
                </div>
            ...
            <div class="p-1 py-3">
                ...
                <div class="card shadow-sm rounded-3 carta">
                  <a class="icono" href="agregar_cliente.php">
                  <ion-icon class="icons" name="add-circle-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Agregar Cliente</h6>
                  </div>
              </a>
                </div>
            ...
            <div class="p-1 py-3">
                ...
                <div class="card shadow-sm rounded-3 carta" >
                  <a class="icono" href="editar_cliente.php">
                  <ion-icon class="icons" name="create-outline"></ion-icon>
                  <div class="card-body">
                    <h6 class="card-text">Editar Cliente</hh6>
                  </div>
              </a>
                </div>
